...
-- Enable RLS and create policies for stripe_customers
...
-- Enable RLS and create policies for stripe_subscriptions
...
-- Enable RLS and create policies for stripe_orders
