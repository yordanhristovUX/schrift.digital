...
const About: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('about.meta.title', 'За българската кирилица | Schrift.Digital')}</title>
        <meta name="description" content={t('about.meta.description', 'Научете повече за мисията ни да върнем българската кирилица в съвременния дизайн с нашите професионални шрифтове.')} />
      </Helmet>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="prose prose-lg max-w-none space-y-8 text-[#141204] font-['Listopad']">
            ...
            <div className="bg-[#FFFFFC] rounded-sm shadow-md p-8 my-12 border border-[#D9D9D9]">
              <h2 className="text-2xl font-bold mb-4 font-['Listopad'] text-[#141204]">Нашата мисия</h2>
