        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="mb-12">
            <input
              ...
              className="w-full text-4xl p-6 bg-[#FFFFFC] text-text-primary border border-[#D9D9D9] hover:border-[#141204] focus:border-[#141204] focus:outline-none transition-colors duration-200 rounded-sm font-['Listopad']"
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">
                        <span className="font-['Listopad']">Автор:</span> {font.designer}
                      </p>
                    </div>
                    <button
